...
<%} %>
    ...
    <div class='container'>
        <div class='section'>
			...
			<form action="/project/api/MatchingUpdate" method="post">
				<input type=hidden name= num value="${MatchingContent.num }">
				<table >
				    <tr>
				        <th scope="row">작성자</th>
				    ...
				    <tr>
				        <th scope="row">제목</th>
				        <td><input type=text name="title" value="${MatchingContent.title}" style=" width:500px "></td>
				    </tr>
				    <tr>
				        <th scope="row">내용</th>
				        <td><input type=text name="content" value="${MatchingContent.content}" style=" width:500px;height: 300px;"></td>
				    </tr>
				...
				<div>
                    ...
                    <input type="button" value="취소" onclick="location.href='/project/MatchingForm'" class=button>
				</div>
